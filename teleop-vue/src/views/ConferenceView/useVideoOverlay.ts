...
export default function(overlayVideoRef : Ref<HTMLVideoElement>) {
    ...
    const _initLocalVideo = () => {
        ...
        overlayVideo.srcObject = store.state.localClient.openteraVideoConf.localStream;
        overlayVideo.autoplay = true;
    };

    const stream = computed(() => store.state.localClient.openteraVideoConf.localStream);
